...
var AuthorWhere = struct {
	...
	Birthdate: whereHelpertime_Time{field: "`authors`.`birthdate`"},
	Added:     whereHelpertime_Time{field: "`authors`.`added`"},
}
...
var (
	authorAllColumns            = []string{"id", "first_name", "last_name", "email", "birthdate", "added"}
	authorColumnsWithoutDefault = []string{"first_name", "last_name", "email", "birthdate"}
	authorColumnsWithDefault    = []string{"id", "added"}
