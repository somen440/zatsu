...
var PostWhere = struct {
	...
	Date:        whereHelpertime_Time{field: "`posts`.`date`"},
}
...
var (
	postAllColumns            = []string{"id", "author_id", "title", "description", "content", "date"}
	postColumnsWithoutDefault = []string{"author_id", "title", "description", "content", "date"}
